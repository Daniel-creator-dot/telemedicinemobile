...
import '../patient/messages_view.dart';

// ---------------------------------------------------------------------------
// Tab enum
// ---------------------------------------------------------------------------
enum _DoctorTab { overview, appointments, queue, messages, doctors, reports }
...
class _DoctorHomeScreenState extends State<DoctorHomeScreen> {
  ...
  Widget _buildTopBar(Session session, bool isDesktop) {
    final tabLabels = {
      ...
      _DoctorTab.messages: 'Patient Messages',
                ...
                Expanded(
                  child: Row(
                    children: [
                      ...
                      _headerTabItem('Messages', _DoctorTab.messages, Icons.chat_bubble_rounded),
  ...
  Widget _buildBottomNav() {
    final items = [
      ...
      (_DoctorTab.messages, Icons.chat_bubble_rounded, 'Chats'),
